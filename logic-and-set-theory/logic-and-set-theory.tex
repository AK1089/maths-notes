...
\begin{theorem}[Principle of $\in$-duction]
...
\begin{theorem}[Foundation Equivalence]
...
\begin{theorem}[Principle of $\in$-cursion]
...
\begin{proposition}[Ordinal Properties]
...
\begin{example}[Ordinals up to $\omega$]
...
\ctikzfig{von-neumann-hierarchy}
...
\begin{proposition}[Ordinal Transitivity]
...
\begin{proposition}[Ordinal Nesting]
...
\begin{theorem}[Exhaustivity of von Neumann Hierarchy]
...
\begin{proposition}[Rank Relation]
...
\begin{definition}[Cardinality in ZFC]
...
\begin{example}[Initial Ordinals]
...
\begin{definition}[Recursive $\omega$-ordinals]
...
\begin{proposition}[Initial Ordinals]
...
\begin{definition}[Cardinal Ordering]
...
\begin{remark}[Properties of Cardinal Arithmetic]
...
\begin{theorem}[Squaring Cardinals]
